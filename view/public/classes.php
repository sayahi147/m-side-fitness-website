		...
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="classess-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="classes/class"><img src="assets/images/resource/feature-1.jpg" alt="" /></a>
							<div class="icon-box">
						...
						<div class="lower-content">
							...
							<h4><a href="classes/class">Psycho Training</a></h4>
							<div class="text">Winning means you’re willing to go longer, work harder for more.</div>
							<a class="read-more" href="classes/class">Read More</a>
						</div>
					</div>
				</div>
				...
				<div class="classess-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="classes/class"><img src="assets/images/resource/feature-2.jpg" alt="" /></a>
							<div class="icon-box">
						...
						<div class="lower-content">
							...
							<h4><a href="classes/class">Self Defence</a></h4>
				...
				<div class="classess-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="classes/class"><img src="assets/images/resource/feature-3.jpg" alt="" /></a>
							<div class="icon-box">
						...
						<div class="lower-content">
							...
							<h4><a href="classes/class">FITNESS FOR MAN</a></h4>
							<div class="text">Winning means you’re willing to go longer, work harder for more.</div>
							<a class="read-more" href="classes/class">Read More</a>
						</div>
					</div>
				...
				<div class="classess-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="classes/class"><img src="assets/images/resource/feature-4.jpg" alt="" /></a>
							<div class="icon-box">
						...
						<div class="lower-content">
							...
							<h4><a href="classes/class">Strength Training</a></h4>
							<div class="text">Winning means you’re willing to go longer, work harder for more.</div>
							<a class="read-more" href="classes/class">Read More</a>
						</div>
					</div>
				...
				<div class="classess-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="classes/class"><img src="assets/images/resource/feature-5.jpg" alt="" /></a>
							<div class="icon-box">
						...
						<div class="lower-content">
							<div class="title">CARDIO</div>
							<h4><a href="classes/class">Cardio For Man</a></h4>
							<div class="text">Don’t practice until you get it right practice until can’t wrong</div>
							<a class="read-more" href="classes/class">Read More</a>
						</div>
					</div>
				...
				<div class="classess-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="classes/class"><img src="assets/images/resource/feature-6.jpg" alt="" /></a>
							<div class="icon-box">
						...
						<div class="lower-content">
							...
							<h4><a href="classes/class">Advance GYM</a></h4>
							<div class="text">Winning means you’re willing to go longer, work harder for more.</div>
							<a class="read-more" href="classes/class">Read More</a>
						</div>
					</div>
