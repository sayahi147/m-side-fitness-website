		...
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="classess-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="class"><img src="assets/images/resource/feature-1.jpg" alt="" /></a>
							<div class="icon-box">
				...
				<div class="classess-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="class"><img src="assets/images/resource/feature-2.jpg" alt="" /></a>
							<div class="icon-box">
				...
				<div class="classess-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="class"><img src="assets/images/resource/feature-3.jpg" alt="" /></a>
							<div class="icon-box">
				...
				<div class="classess-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="class"><img src="assets/images/resource/feature-4.jpg" alt="" /></a>
							<div class="icon-box">
				...
				<div class="classess-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="class"><img src="assets/images/resource/feature-5.jpg" alt="" /></a>
							<div class="icon-box">
				...
				<div class="classess-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="class"><img src="assets/images/resource/feature-6.jpg" alt="" /></a>
							<div class="icon-box">
