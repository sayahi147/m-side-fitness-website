		...
		<div class="auto-container">
			<div class="inner-box">
				...
				<div class="row clearfix">
					...
					<div class="content-column col-lg-8 col-md-12 col-sm-12">
						<div class="inner-column">
							...
							<h3>FUN WORKOUTS</h3>
							<p>Lorem ipsum proin gravida nibh vel velit auctor aliqunean sollicitudinlorem quis bibendum auci elit consequa ipsutis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris.</p><br>
							<div class="row clearfix">
								...
								<div class="column col-lg-6 col-md-6 col-sm-12">
									...
									<div class="featured-block">
										<div class="block-inner">
											<span class="icon flaticon-man-1"></span>
				...
				<div class="more-posts clearfix">
					<div class="pull-left">
						<div class="btn-one-outer"><a href="portfolio#" class="theme-btn btn-style-one"><span class="txt">PREVIOUS</span></a></div>
					</div>
					<div class="pull-right">
						<div class="btn-one-outer"><a href="portfolio#" class="theme-btn btn-style-one"><span class="txt">Next</span></a></div>
					</div>
				</div>
