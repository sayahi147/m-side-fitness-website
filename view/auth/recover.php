...
<div class="login">
    ...
    <?php endif;?>
	<?php if($step == 3): ?>
			<input type="password" name="password" placeholder="New password" required="required" pattern="(?=.*\d)(?=.*\W)(?=.*[a-zA-Z]).{8,}" />
			<input type="password" name="r_password" placeholder="Repeat new password" pattern="(?=.*\d)(?=.*\W)(?=.*[a-zA-Z]).{8,}" required="required" />    
