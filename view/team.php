			...
			<div class="row clearfix">
				...
				<div class="team-block col-lg-4 col-md-4 col-sm-12">
					<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="content">
							...
							<div class="name">MATIE JUNIOR</div>
						</div>
				...
				<div class="team-block col-lg-4 col-md-4 col-sm-12">
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="image">
							<img src="assets/images/resource/borhan.png" alt="" />
						</div>
						<div class="content">
							<div class="title">Bodybuilding Coach</div>
							<div class="name">Steve Cross</div>
						</div>
						<div class="shared-boxed">
							<div class="shared-inner">
								<span class="share-now fa fa-share-alt"></span>
				...
				<div class="team-block col-lg-4 col-md-4 col-sm-12">
					<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="image">
							<img src="assets/images/resource/amine.png" alt="" />
						</div>
						<div class="content">
				...
				<div class="team-block col-lg-4 col-md-4 col-sm-12">
					<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="content">
							<div class="title">Crossfit Coach</div>
							<div class="name">JUNIFOR Jonas</div>
						</div>
						<div class="shared-boxed">
							<div class="shared-inner">
								<span class="share-now fa fa-share-alt"></span>
				...
				<div class="team-block col-lg-4 col-md-4 col-sm-12">
					<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="content">
							<div class="title">Bodybuilding Coach</div>
							<div class="name">SMITH Cross</div>
						</div>
						<div class="shared-boxed">
							<div class="shared-inner">
								<span class="share-now fa fa-share-alt"></span>
				...
				<div class="team-block col-lg-4 col-md-4 col-sm-12">
					<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="content">
							<div class="title">Cardio & Conditioning</div>
							<div class="name">MONICA JAND</div>
						</div>
						<div class="shared-boxed">
							<div class="shared-inner">
								<span class="share-now fa fa-share-alt"></span>
