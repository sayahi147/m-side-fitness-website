...
$sql[] = "CREATE TABLE IF NOT EXISTS `packs` ( `id` INT NOT NULL AUTO_INCREMENT, `title` TEXT NOT NULL ,`description` TEXT NOT NULL,`content` TEXT NOT NULL , `duration` VARCHAR(32) NOT NULL , `price` FLOAT  NOT NULL,`image` TEXT,PRIMARY KEY (`id`)";
$sql[] = "CREATE TABLE IF NOT EXISTS `planning` ( `id` INT NOT NULL AUTO_INCREMENT, `cours` TEXT NOT NULL ,`coach` TEXT NOT NULL,`jour` TEXT NOT NULL , `time` TEXT NOT NULL ,PRIMARY KEY (`id`)";
